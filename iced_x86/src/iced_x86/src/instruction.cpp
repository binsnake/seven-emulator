...
MemorySize Instruction::memory_size_enum() const noexcept {
	return internal::g_instruction_memory_sizes[static_cast< std::size_t >( code_ )];
}
size_t Instruction::memory_size() const noexcept {
	auto mem_size = internal::g_instruction_memory_sizes[static_cast<std::size_t>(code_)];
