...
struct OpCodeHandler_Group8x8 {
  bool has_modrm;
  HandlerEntry table_low[8];   // mod != 3 (memory)
  HandlerEntry table_high[8];  // mod == 3 (register)
...
struct OpCodeHandler_Group8x64 {
  bool has_modrm;
 HandlerEntry table_low[8];
  HandlerEntry table_high[64];
...
struct OpCodeHandler_MandatoryPrefix {
  bool has_modrm;
  HandlerEntry handlers[4];  // [0]=none, [1]=66, [2]=F3, [3]=F2
...
struct OpCodeHandler_MandatoryPrefix3 {
  bool has_modrm;
  HandlerEntry handlers_reg[4];
  HandlerEntry handlers_mem[4];
  uint32_t flags;
...
struct OpCodeHandler_VEX_MandatoryPrefix2 {
  bool has_modrm;
  HandlerEntry handlers[4];  // [0]=NP, [1]=66, [2]=F3, [3]=F2
